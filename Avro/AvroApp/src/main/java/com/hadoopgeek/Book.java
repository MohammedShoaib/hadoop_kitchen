...
public class Book extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Book\",\"namespace\":\"com.hadoopgeek\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"id\",\"type\":[\"int\",\"null\"]},{\"name\":\"category\",\"type\":[\"string\",\"null\"]}]}");
  ...
  public static com.hadoopgeek.Book.Builder newBuilder() {
    return new com.hadoopgeek.Book.Builder();
  }
  
  /** Creates a new Book RecordBuilder by copying an existing Builder */
  public static com.hadoopgeek.Book.Builder newBuilder(com.hadoopgeek.Book.Builder other) {
    return new com.hadoopgeek.Book.Builder(other);
  }
  
  /** Creates a new Book RecordBuilder by copying an existing Book instance */
  public static com.hadoopgeek.Book.Builder newBuilder(com.hadoopgeek.Book other) {
    return new com.hadoopgeek.Book.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Book>
    ...
    private Builder() {
      super(com.hadoopgeek.Book.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.hadoopgeek.Book.Builder other) {
      super(other);
    ...
    private Builder(com.hadoopgeek.Book other) {
            super(com.hadoopgeek.Book.SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'name' field */
    public com.hadoopgeek.Book.Builder setName(java.lang.CharSequence value) {
    ...
    public com.hadoopgeek.Book.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'id' field */
    public com.hadoopgeek.Book.Builder setId(java.lang.Integer value) {
    ...
    public com.hadoopgeek.Book.Builder clearId() {
      id = null;
    ...
    /** Sets the value of the 'category' field */
    public com.hadoopgeek.Book.Builder setCategory(java.lang.CharSequence value) {
    ...
    public com.hadoopgeek.Book.Builder clearCategory() {
      category = null;
